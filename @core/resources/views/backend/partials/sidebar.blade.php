                        ...
                        'admin-home/frontend/student/*',
                                    ...
                                    <ul class="collapse">
                                        <li class="{{active_menu('admin-home/frontend/student/all')}}"><a
                                                    href="{{route('admin.all.frontend.student')}}">{{__('All Students')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/frontend/student/new')}}"><a
                                                    href="{{route('admin.frontend.new.student')}}">{{__('Add New Student')}}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif

                            @if(check_page_permission_by_string('Stages Manage'))
                                <li
                                        class="main_dropdown
                        @if(request()->is([
                        'admin-home/school/stage/*',
                                                ...
                                                ">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        <span>{{__('Stages Manage')}}</span></a>
                                    <ul class="collapse">
                                        <li class="{{active_menu('admin-home/school/stage/all')}}"><a
                                                    href="{{route('admin.all.school.stage')}}">{{__('All Stages')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/school/stage/new')}}"><a
                                                    href="{{route('admin.school.new.stage')}}">{{__('Add New Stage')}}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                                ...
                                <li class="main_dropdown @if(request()->is('admin-home/appointment/*')) active @endif ">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{active_menu('admin-home/appointment/all')}}">
                                            <a href="{{route('admin.appointment.all')}}">{{__('All appointment')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/new')}}">
                                            <a href="{{route('admin.appointment.new')}}">{{__('New Appointment')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/category')}}">
                                            <a href="{{route('admin.appointment.category.all')}}">{{__('Category')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/booking-time')}}">
                                            <a href="{{route('admin.appointment.booking.time.all')}}">{{__('Booking Time')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/booking')}}">
                                            <a href="{{route('admin.appointment.booking.all')}}">{{__('All Appointment Booking')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/review')}}">
                                            <a href="{{route('admin.appointment.review.all')}}">{{__('All Reviews')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/form-builder')}}">
                                            <a href="{{route('admin.appointment.booking.form.builder')}}">{{__('Booking Form Builder')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/appointment/settings')}}">
                                            <a href="{{route('admin.appointment.booking.settings')}}">{{__('Settings')}}</a>
                                        </li>
                                    </ul>
                                </li>
                            @endif
                            ...
                            @if(check_page_permission_by_string('Events Manage') && !empty(get_static_option('events_module_status')))
                                <li class="main_dropdown
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{active_menu('admin-home/events/payment-success-page-settings')}}">
                                            <a
                            ...
                            @if(check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donations_module_status')))
                                ...
                                @if(request()->is('admin-home/donations/*')) active @endif
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{active_menu('admin-home/donations/payment-success-page-settings')}}">
                                            <a
                                                    href="{{route('admin.donations.payment.success.page.settings')}}">{{__('Payment Success Page Settings')}}</a>
                                        </li>
                                        <li class="{{active_menu('admin-home/donations/payment-cancel-pag-settings')}}">
                                            <a
                                        ...
                                        @if(empty(get_static_option('home_page_page_builder_status')))
                                            @if(in_array($home_page_variant,['01','02','03','04']))
                                                ...
                                                @if($home_page_variant != '03')
                                                    <li class="{{active_menu('admin-home/home-page-01/quality-area')}}">
                                                        <a
                                                                href="{{route('admin.homeone.quality.area')}}">{{__('Quality Area')}}</a>
                                                    </li>
                                                @endif
                                                <li class="{{active_menu('admin-home/home-page-01/case-study-area')}}">
                                                    <a
                                                ...
                                                @if(in_array($home_page_variant,['04','02']))
                                                    <li class="{{active_menu('admin-home/home-page-01/team-member')}}">
                                                        <a
                                                                href="{{route('admin.homeone.team.member')}}">{{__('Team Member Area')}}</a>
                                                    </li>
                                                @endif
                                                @if(in_array($home_page_variant,['03','02']))
                                                    <li class="{{active_menu('admin-home/home-page-01/brand-logos')}}">
                                                        <a
