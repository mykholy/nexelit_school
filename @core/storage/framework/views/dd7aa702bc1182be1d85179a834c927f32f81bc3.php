...
<?php endif; ?> 
                                                        ...
                                                        <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.jobs.edit',$data->id)); ?>">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-xs btn-info btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.jobs.single',$data->slug)); ?>">
                                                            <i class="ti-eye"></i>
                                                        </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/jobs/all-jobs.blade.php ENDPATH**/ ?>