...
<?php endif; ?> 
                                                        ...
                                                        <?php if($data->payment_gateway == 'manual_payment' && $data->status == 'pending'): ?>
                                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.backend.payment-approve','data' => ['url' => route('admin.donations.payment.approve',$data->id)]]); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/donations/donation-payment-logs-all.blade.php ENDPATH**/ ?>