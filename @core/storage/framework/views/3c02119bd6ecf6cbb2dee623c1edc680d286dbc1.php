<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Package Order Status Change Template')); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapp d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Package Order Status Change Template')); ?></h4>
                            <a class="btn btn-info" href="<?php echo e(route('admin.email.template.all')); ?>"><?php echo e(__('All Email Templates')); ?></a>
                        </div>
                        <form action="<?php echo e(route('admin.email.template.package.order.status.change')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <nav>
                                ...
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            <label for="package_order_status_change_<?php echo e($lang->slug); ?>_subject"><?php echo e(__('Subject')); ?></label>
                                            <input type="text" name="package_order_status_change_<?php echo e($lang->slug); ?>_subject"  class="form-control" value="<?php echo e(get_static_option('package_order_status_change_'.$lang->slug.'_subject')); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="package_order_status_change_<?php echo e($lang->slug); ?>_message"><?php echo e(__('Message')); ?></label>
                                            <input type="hidden" name="package_order_status_change_<?php echo e($lang->slug); ?>_message"  class="form-control" value="<?php echo e(get_static_option('package_order_status_change_'.$lang->slug.'_message')); ?>" >
                                            <div class="summernote" data-content='<?php echo e(get_static_option('package_order_status_change_'.$lang->slug.'_message')); ?>'></div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/email-template/package-order/status-change.blade.php ENDPATH**/ ?>