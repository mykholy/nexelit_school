                ...
                <?php $__empty_1 = true; $__currentLoopData = $all_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="course-single-grid-item">
                            <div class="thumb">
                                <a href="<?php echo e(route('frontend.course.single',[optional($data->lang_front)->slug,$data->id])); ?>">
                                ...
                                <div class="cat">
                                    <a class="bg-<?php echo e($a); ?>" href="<?php echo e(route('frontend.course.category',[Str::slug(optional(optional($data->category)->lang_front)->title,'-',optional(optional($data->category)->lang_front)->lang),$data->category->id])); ?>"><?php echo e(optional(optional($data->category)->lang_front)->title); ?></a>
                                </div>
                            </div>
                            <div class="content">
                                ...
                                <?php endif; ?>
                                <h3 class="title"><a href="<?php echo e(route('frontend.course.single',[optional($data->lang_front)->slug,$data->id])); ?>"><?php echo e(Str::words(optional($data->lang_front)->title,6,'..')); ?></a></h3>
                                <div class="instructor-wrap"><span><?php echo e(__('By')); ?></span> <a href="<?php echo e(route('frontend.course.instructor',[Str::slug(optional($data->instructor)->name),$data->instructor->id])); ?>"><?php echo e(optional($data->instructor)->name); ?></a></div>
                                <div class="description">
                                    <?php echo Str::words(strip_tags(optional($data->lang_front)->description),15); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit303/@core/resources/views/frontend/pages/courses/courses.blade.php ENDPATH**/ ?>