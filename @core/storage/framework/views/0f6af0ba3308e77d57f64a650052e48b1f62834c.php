                                            ...
                                            <?php $__currentLoopData = $all_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="alert alert-warning text-capitalize"><?php echo e(__('Pending')); ?></span>
                                                        <?php elseif($data->status === 'canceled'): ?>
                                                            <span class="alert alert-danger text-capitalize"><?php echo e(__('Cancel')); ?></span>
                                                        <?php elseif($data->status === 'in_progress'): ?>
                                                            <span class="alert alert-info text-capitalize"><?php echo e(__('In Progress')); ?></span>
                                                        <?php else: ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/package-order-manage/order-manage-all.blade.php ENDPATH**/ ?>