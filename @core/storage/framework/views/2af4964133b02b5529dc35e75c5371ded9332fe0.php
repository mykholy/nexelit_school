                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.courses.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <hr>
                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.media-upload','data' => ['name' => 'course_certificate_bg_image','title' => __('Certificate Background Image'),'dimentions' => '850x600px']]); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit303/@core/resources/views/backend/courses/course-settings.blade.php ENDPATH**/ ?>