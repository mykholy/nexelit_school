...
<?php endif; ?> 
                                                        ...
                                                        <form action="<?php echo e(route('admin.all.frontend.user.email.status')); ?>" method="post">
                                                            ...
                                                            <?php echo e($data->email_verified); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/frontend-user/all-user.blade.php ENDPATH**/ ?>