...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Event Payment Logs')); ?>
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <h4 class="header-title"><?php echo e(__('All Event Payment Logs')); ?></h4>
                                        ...
                                        <table id="all_user_table" >
                                            ...
                                            <?php $__currentLoopData = $payment_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(!empty($data->attendance_logs->quantity) ? $data->attendance_logs->quantity : ''); ?></td>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.event.payment.delete',$data->id)]]); ?>
<?php $component->withName('delete-popover'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.event.payment.delete',$data->id))]); ?>
...
<?php endif; ?> 
                                                        <a href="#"
                                                           ...
                                                           data-event_name="<?php echo e($data->event_name); ?>"
                                                           data-event_cost="<?php echo e(site_currency_symbol()); ?><?php echo e($data->event_cost); ?>"
                                                           data-payment_gateway="<?php echo e(ucwords(str_replace('_',' ',$data->package_gateway))); ?>"
                                                           data-attendance_id="<?php echo e($data->attendance_id); ?>"
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.event.payment.approve',$data->id)); ?>'>
        ...
        $(document).ready(function($) {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.event.payment.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/backend/events/event-payment-logs-all.blade.php ENDPATH**/ ?>