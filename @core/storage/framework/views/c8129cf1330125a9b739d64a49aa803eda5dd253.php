                        ...
                        'admin-home/frontend/student/*',
                            ...
                            <ul class="collapse">
                                <li class="<?php echo e(active_menu('admin-home/frontend/student/all')); ?>"><a
                                            href="<?php echo e(route('admin.all.frontend.student')); ?>"><?php echo e(__('All Students')); ?></a></li>
                                <li class="<?php echo e(active_menu('admin-home/frontend/student/new')); ?>"><a
                                            href="<?php echo e(route('admin.frontend.new.student')); ?>"><?php echo e(__('Add New Student')); ?></a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
