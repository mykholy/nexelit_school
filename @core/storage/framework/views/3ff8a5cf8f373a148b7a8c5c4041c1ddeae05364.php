    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('keyup','input[name="title"],input[name="slug"]',function (){
                ...
                $.ajax({
                   type: 'post',
                   url : "<?php echo e(route('admin.page.slug.check')); ?>",
                   data: {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/nexelit304/@core/resources/views/backend/pages/page/new.blade.php ENDPATH**/ ?>